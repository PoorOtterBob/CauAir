...
from src.models.mgsfformer import MGSFformer
...
def main():
    ...
    model = MGSFformer(node_num=node_num,
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [1, 25, 50, 75], gamma=0.5)

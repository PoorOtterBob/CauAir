...
from src.models.softs import SOFTS
...
def get_config():
    ...
    parser.add_argument('--num_time_features', type=int, default=2)

    parser.add_argument('--use_norm', type=bool, default=True)
    parser.add_argument('--activation', type=str, default='gelu')

    parser.add_argument('--lrate', type=float, default=2e-2)

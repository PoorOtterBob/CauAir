...
def get_config():
    ...
    parser.add_argument('--clip_grad_value', type=float, default=3)
...
def main():
    ...
    model = DSFormer(node_num=node_num,
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[1, 15, 25, 50, 75, 100], gamma=0.5)

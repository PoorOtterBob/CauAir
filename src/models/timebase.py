...
class TimeBase(BaseModel):
    def __init__(self, **args):
        super(TimeBase, self).__init__(**args)


        self.use_period_norm = False
    ...
    def forward(self, x, label=None, adj=None):
        ...
        if self.use_orthogonal:
            ...
            return x[:, :self.pred_len, :, None], orthogonal_loss
        else:
            return x[:, :self.pred_len, :, None]